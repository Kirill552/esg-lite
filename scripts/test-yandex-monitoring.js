...
async function testYandexMonitoring() {
  ...
  try {
    ...
    const { yandexMonitoring } = await import('../lib/yandex-monitoring.js');
    ...
    if (error.message.includes('Cannot resolve module')) {
      ...
      console.log('   2. Убедитесь, что файлы lib/*.js скомпилированы');
    }
  }
}
...
module.exports = { testYandexMonitoring };
